document.addEventListener("DOMContentLoaded", function () {
  ...
  modifyOnMouse.addEventListener("mouseover", function () {
    if (!isMouseOver) {
      ...
      subTitleSpan.textContent = "Duda de todo, incluso de lo que crees saber.";
  ...
  modifyOnMouse.addEventListener("mouseout", function () {
    ...
    subTitleSpan.textContent =
      "Bienvenid al salón de los misterios, donde un debe olvidar para poder entender, pero no olviden sus dogmas, pues nada es lo que parece.";
    motherSection.appendChild(subTitleSpan);
    modifyOnMouse.appendChild(motherSection);
  });
